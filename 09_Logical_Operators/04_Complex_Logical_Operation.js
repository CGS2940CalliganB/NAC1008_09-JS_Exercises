...
// use the logical AND operator '&&' to check if 'isDaytime' and 'isWeekend' is both true and 'scheduledMeeting' is true.
// Hint: Use the logical NOT operator '!' on 'isWeekend'
// Write your code below
const canAttendMeeting = isDaytime && !isWeekend && scheduledMeeting;
